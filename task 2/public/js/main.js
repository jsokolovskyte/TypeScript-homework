...
{
    const getLastMemberIndex = (ar) => ar.lastIndexOf(ar[ar.length - 1]);
...
{
    function printArrayIndex(ar) {
        ar.forEach((_item, index) => {
            console.log(index);
        });
    }
...
{
    function printArrayItem(ar) {
        ar.forEach((item, _index) => {
            console.log(item);
        });
    }
...
{
    function printArrayItemAndIndex(ar) {
